...
class GaussianModel:
    ...
    def prune_ratio(self):
        ...
        exceed_indices = torch.where(ratio > 10)

        if any(tensor.numel() != 0 for tensor in exceed_indices):
            new_scaling = self._scaling.data.clone()
            new_scaling[exceed_indices] = 10 * min_scales[exceed_indices[0]]
