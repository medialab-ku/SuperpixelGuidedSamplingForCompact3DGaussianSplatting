...
class SuperpixelSampler:
    def __init__(self, args):
        ...
        self.ruler = 50
        self.region_size = 30
        self.SSP = SlicSuperPixel(device=self.device, iteration_N=self.iteration_N, ruler=self.ruler, region_size=self.region_size, IsDrawPolyDecomp=False, rgb_dist_threshold=10, rgb_var_dist_threshold=10)
